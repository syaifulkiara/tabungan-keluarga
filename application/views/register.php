            ...
            <div class="card">
                <div class="body">
                     <?php 
                        ...
                        echo form_open(base_url('auth/register'), ['class' => 'form-auth-small']);
                        ?>
                            ...
                            <div class="form-group c_form_group">
                                ...
                                <input type="password" name="password_confirm" class="form-control" placeholder="Ulangi kata sandi">
                            </div>
                                <div class="g-recaptcha" data-sitekey="6LeFIyYrAAAAAD16RYOGac6U7xmIgkSe8mAAScPB"></div>
                                <input type="hidden" name="role" value="member">
                            <button type="submit" class="btn btn-dark btn-lg btn-block">DAFTAR</button>
                            <div class="bottom">
                                <span>Sudah punya akun? <a href="<?= base_url('auth') ?>">Masuk</a></span>
                            </div>
                        <?php echo form_close(); ?> 
                </div>
            </div>
